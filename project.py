...
mydb=mysql.connector.connect(host="localhost",user="root",passwd="snehith")  
...
class window7():
    ...
    def __init__(self,root):
        ...
        #user & pass entry and set focus
        def l_focus1(event):
            staff_pass_entry.focus_set()
        
        
        self.staff_u=StringVar()
        self.staff_p=StringVar()
        staff_user_entry=Entry(staff_login_frame,textvariable=self.staff_u,font=("times new roman",15),bg="lightgrey")
        staff_user_entry.place(x=65,y=188,width=320,height=35)
        staff_pass_entry=Entry(staff_login_frame,textvariable=self.staff_p,font=("times new roman",15),bg="lightgrey",show="*")
        staff_pass_entry.place(x=65,y=305,width=320,height=35)
        
        # bind method of widget is used  
        staff_user_entry.bind("<Return>",l_focus1) 
